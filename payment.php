...
if(isset($_POST['selected_location'])) {
    ...
    $restaurant_query = "SELECT City FROM resturant WHERE Resturant_id = (SELECT Resturant_id FROM cart WHERE Cart_id = $customer_id LIMIT 1)";
...
<div class="payment-container">
    ...
    <div class="mobile-banking-options">
        ...
        <label><input type="radio" name="mobile_banking_option" value="Nogod"> Nogod</label>
    </div>
...
<script>
    function proceedToPayment() {
        ...
        window.location.href = "delivery.php?delivery_fee=<?php echo $delivery_fee; ?>";
    }
